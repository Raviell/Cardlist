create table card (id int auto_increment  primary key, nome varchar(250) not null, nivel varchar(250) not null, tipo varchar(250) not null, pontos varchar(250) not null);
